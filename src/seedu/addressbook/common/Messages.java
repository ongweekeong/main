...
public class Messages {
    ...
    public static final String MESSAGE_PERSON_NOT_IN_ADDRESSBOOK = "Person could not be found in the Police Records";
    public static final String MESSAGE_PO_NOT_FOUND = "PO not found, try a different ID";
    public static final String MESSAGE_PERSONS_LISTED_OVERVIEW = "%1$d person listed!";
    public static final String MESSAGE_TIMESTAMPS_LISTED_OVERVIEW = "%s was screened %d time(s)";
    public static final String MESSAGE_UNREAD_MSG_NOTIFICATION = "You have %1$d unread message(s).";
