...
public class ClearInboxCommand extends Command {
    ...
    public static final String MESSAGE_CLEARINBOX_UNSUCCESSFUL = "Unable to clear inbox. Ensure that the file exists in %s";

    @Override
    public CommandResult execute() {

        try {
            String myInbox = MessageFilePaths.getFilePathFromUserId(Password.getID());
            ...
            return new CommandResult(String.format(MESSAGE_CLEARINBOX_UNSUCCESSFUL, MessageFilePaths.getFilePathFromUserId(Password.getID())));
        }
