...
.	Download the latest version of PRISM https://github.com/CS2113-AY1819S1-F10-3/main/releases/download/v1.3.1/PRISM.jar[here].
...
Edit a specified parameter of an existing person in PRISM - only by HQP
...
Clears all records of people in policeRecords.txt
