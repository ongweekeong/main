...
[NOTE]
If you do not specify any tasks, Gradlew will run the default tasks `clean` `asciidoctor` `test` `checkstyleMain` `checkstyleTest`
...
Example:
* `./gradlew clean test` -- Cleans project and runs tests
